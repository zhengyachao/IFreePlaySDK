                        ...
                        timestamp:(UInt32)timestamp_key
{
    ...
    //添加商户密钥key字段
    [contentString appendFormat:@"key=%@", @"Beijyoukonghuyu20170829ifreeplay"];
    
    NSString *result = [self createMd5EncryptionRules:contentString];
    return result;
}

/* 重新生成新的Md5加密*/
+ (NSString *)createMd5EncryptionRules:(NSString *)str
{
